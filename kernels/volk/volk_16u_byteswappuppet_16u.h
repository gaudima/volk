...
static inline void volk_16u_byteswappuppet_16u_neon64(uint16_t*output, uint16_t* intsToSwap, unsigned int num_points){

    volk_16u_byteswap_neon64((uint16_t*)intsToSwap, num_points);
    memcpy((void*)output, (void*)intsToSwap, num_points * sizeof(uint16_t));
...
#ifdef LV_HAVE_NEON64
static inline void volk_16u_byteswappuppet_16u_neon64_table(uint16_t*output, uint16_t* intsToSwap, unsigned int num_points){

    volk_16u_byteswap_neon64_table((uint16_t*)intsToSwap, num_points);
    memcpy((void*)output, (void*)intsToSwap, num_points * sizeof(uint16_t));
